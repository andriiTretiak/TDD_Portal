...
describe('Login page', () => {
    ...
    describe('Interactions', () => {
        ...
        const setupForSubmit = (props) => {
            const renderer = render(<LoginPage {...props} />);
            const { container, queryByPlaceholderText } = renderer;
        ...
        it('clears alert when user change username', async () => {
            const actions = {
                postLogin: jest.fn().mockRejectedValue({
                    response: {
                        data: {
        ...
        it('clears alert when user change password', async () => {
            const actions = {
                postLogin: jest.fn().mockRejectedValue({
                    response: {
                        data: {
